...
Libraries are shareable across libraries and applications. They can be imported from `@test-stuff-fourteen/mylib`.
...
- npx create-nx-workspace@14.8.6 test-stuff-fourteen
